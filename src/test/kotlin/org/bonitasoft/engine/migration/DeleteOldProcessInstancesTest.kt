...
@SpringBootTest
class DeleteOldProcessInstancesTest {
    val logger = LoggerFactory.getLogger(DeleteOldProcessInstancesTest::class.java)
    ...
    private fun createTablesFromScript(fileName: String) {
        ...
        val content = DeleteOldProcessInstances::class.java.getResource(fileName).readText()
...
//        }
//
//        deleteOldProcessInstances.execute()
//
//
